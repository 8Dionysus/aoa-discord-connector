"""Portable claim extraction primitives for Discord forum evidence."""
...
CLAIM_EXTRACTOR_VERSION = "discord_claim_heuristic_v1"
    ...
    for action in _entities_by_kind(entities, "root_action"):
        ...
        claims.append(
            _claim(
                ...
                confidence=0.76,
                extraction_rule="discord_root_action_entity_v1",
    ...
    for action in _entities_by_kind(entities, "recovery_action"):
        ...
        claims.append(
            _claim(
                ...
                warning_labels=warning_labels,
                confidence=0.68,
                extraction_rule="discord_recovery_action_entity_v1",
                manual_review_required=manual_review,
                evidence_span=_evidence_span(text, action_label),
            )
        )
    ...
    for warning in _entities_by_kind(entities, "warning"):
        ...
        claims.append(
            _claim(
                ...
                confidence=0.72,
                extraction_rule="discord_warning_entity_v1",
                manual_review_required=manual_review,
    ...
    for status in _entities_by_kind(entities, "status"):
        ...
        claims.append(
            _claim(
                ...
                warning_labels=[],
                confidence=0.62,
                extraction_rule="discord_status_language_v1",
...
def _upsert_node(nodes: dict[str, dict[str, object]], node_id: str, kind: str, label: str, source_url: str, confidence: float) -> None:
    node = nodes.setdefault(
        node_id,
        {
            "schema": "aoa_discord_graph_node_v1",
            "node_id": node_id,
            "kind": kind,
            "label": label,
            "source_refs": [],
