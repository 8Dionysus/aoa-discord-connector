"""Query Discord message indexes and optional graph context."""
...
from aoa_discord_connector.index import tokenize
        ...
        results.append(
            {
                ...
                "evidence_refs": [doc_id, f"discord-message:{doc.get('message_id')}"],
