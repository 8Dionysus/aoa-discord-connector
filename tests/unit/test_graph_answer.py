...
from aoa_discord_connector.query import query_graph_packet


FIXTURE = Path("connector/fixtures/discord/starter_conversation.json")


def _build(tmp_path: Path, mode: str = "bot_gateway_message_content") -> tuple[Path, Path]:
    normalized_dir = tmp_path / "normalized"
    normalize_snapshot(FIXTURE, "discord:fixture", normalized_dir, mode=mode)
